...
/********************************************************************/
INT64RSA mask[DHEX] = { 0x80000000, 0x40000000, 0x20000000, 0x10000000,0x8000000,
...
void CONV_B_to_R(short* A, INT64RSA* B, short mn)
{
	int i, j, k;
...
/********************************************************************/
void CONV_R_to_B(INT64RSA* A, short* B, short mn)
{
	int i, j, k;
...
/********************************************************************/
void Modular(INT64RSA* X, INT64RSA* N, short mn)
{
	int  i, j, k;
	short shift, posit;
	INT64RSA  arryA[2 * mb + 1] = { 0, }, arryN[2 * mb + 1] = { 0, };
	INT64RSA  acumA, acumB, acumN, acumQ;
	INT32RSA  acumC;
...
/********************************************************************/
void Conv_mma(INT64RSA* A, INT64RSA* B, INT64RSA* C, INT64RSA* N, short mn)
{
	int  i, j, k;
	INT64RSA arryC[mb * 2], X[mb * 2];         /** temporary arrys **/
	INT64RSA acumA;                     /** temporary acumulators **/
	INT32RSA acumC;
...
/********************************************************************/
INT64RSA  o_mask[8] = { 0x80,0x40, 0x20, 0x10, 0x08,0x04, 0x02, 0x01 };

void CONV_B_to_O(short* A, INT64RSA* B, short mn)
{
	int i, j, k;
...
/********************************************************************/
void CONV_O_to_B(INT64RSA* A, short* B, short mn)
{
	int i, j, k;
...
/********************************************************************/
void LeftTORight_Pow(INT64RSA* A, INT64RSA* E, INT64RSA* C, INT64RSA* N, short mn)
{
	int i;
	INT64RSA arryC[mb] = { 0, };
	short e[m] = { 0, };
